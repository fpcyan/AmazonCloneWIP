...
ActiveRecord::Schema.define(version: 20151202045851) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer  "cvc_code",   null: false
  end

  add_index "payments", ["cvc_code"], name: "index_payments_on_cvc_code", using: :btree
